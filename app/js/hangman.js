...
const titlePausedImg = `<img src="./assets/images/paused.svg" alt="Text that says, 'Paused'"/>`;
const titleWinImg = `<img src="./assets/images/you-win.svg" alt="Text that says, 'You Win'"/>`;
const titleLoseImg = `<img src="./assets/images/you-lose.svg" alt="Text that says, 'You Lose'"/>`;
